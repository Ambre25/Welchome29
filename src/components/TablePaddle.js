...
const rows = [
  createData('PADDLE 1 PLACE', '22€', '33€', '42€'),
  createData('PADDLE 2-4 PLACES', '30€', '47€', '59€'),
  createData('PADDLE 4-10 PLACES', '53€', '80€', '/'),
];

export default function TablePaddle() {
  return (
    <TableContainer sx={{ display: 'flex', justifyContent: 'center' }}>
      <Table sx={{ minWidth: 300, maxWidth: 1200 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>TYPES DE PADDLE</StyledTableCell>
