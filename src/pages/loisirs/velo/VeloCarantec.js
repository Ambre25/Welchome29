...
import mainBg from '../../../assets/bg-velo-car.jpg'
...
export default function VeloCarantec() {
    ...
    const handleAddToCart = () => {
        ...
        const itemId = `Velocarantec-${departureDateString}-${returnDateString}`;
        ...
        addToCart({
          id: itemId,
          type: 'velo',
          name: 'Location de vélo à Carantec',
  ...
  return (
    <>
        ...
        <div style={{ marginTop: '25px' }}>
            <Title text="LOUER UN VÉLO À CARANTEC" />
        </div>
        <div style={{ marginTop: '25px' }}>
