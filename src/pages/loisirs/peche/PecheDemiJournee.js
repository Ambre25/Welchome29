...
import mainBg from '../../../assets/bg-peche-demi.jpg'
...
export default function PecheDemiJournee() {
    ...
    const handleAddToCart = () => {
        ...
        const itemId = `Peche-demi-journee-${dateString}`;
        ...
        addToCart({
          id: itemId,
          type: 'peche',
          name: 'Sortie pêche à la demi journée',
          adults,
          children,
          date_peche: jsDate,
  ...
  return (
    <>
        ...
        <div style={{ marginTop: '25px' }}>
            <Title text="RÉSERVATION SORTIE PÊCHE À LA 1/2 JOURNÉE" />
        </div>
        <div style={{ marginTop: '25px' }}>
            <TablePecheSoiree />
        </div>
