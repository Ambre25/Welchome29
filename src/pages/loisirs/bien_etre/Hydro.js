...
import mainBg from '../../../assets/bg-bienetre-hydro.jpg'
...
import TableHydro from '../../../components/TableHydro'
...
export default function Hydro() {
    ...
    const handleAddToCart = () => {
        ...
        const itemId = `Hydro-${dateString}-${timeString}`;

        const totalPrice = adults * 65;
        ...
        addToCart({
          id: itemId,
          type: 'bien-etre',
          name: 'Pause hydrosensorielle',
          adults,
          date_bienetre: Timestamp.fromDate(jsDate),
          time_bienetre: Timestamp.fromDate(jsTime),
          quantity: adults,
  ...
  return (
    <>
        ...
        <div style={{ marginTop: '25px' }}>
            <Title text="RÉSERVATION PAUSE HYDROSENSORIELLE À ROSCOFF" />
        </div>
        <div style={{ marginTop: '25px' }}>
            <TableHydro />
        </div>
