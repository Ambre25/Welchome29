// PANIER DE LÉGUMES 2P DETAILS PAGE
...
export default function PanierLegumes() {
  return (
    <>
      ...
      <BodyPage>
        <ProductDetails productName='Panier de Légumes' 
          title='PANIER DE LÉGUMES DE SAISON' 
          showAddToCart={true}
          description="Découvrez les délices de la Bretagne avec notre panier de légumes de saison pour deux personnes ! 
