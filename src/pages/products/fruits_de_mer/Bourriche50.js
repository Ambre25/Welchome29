// BOURRICHE 50 HUÎTRES DETAILS PAGE
...
export default function Bourriche50() {
  return (
    <>
      <ShopNavBar />
      <BannerAnimate tween1="DÉCOUVREZ NOS PRODUITS LOCAUX" tween2='LA LIVRAISON EST OFFERTE' />
      <BodyPage>
        <ProductDetails productName='Bourriche de 50 huîtres' 
          title='BOURRICHE DE 50 HUÎTRES CREUSES n°3' 
          showAddToCart={true}
          description="Découvrez la perfection des saveurs marines avec notre bourriche de 50 huîtres creuses n°3, 
